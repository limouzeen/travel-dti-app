...
//         // ✅ ใช้ URL ใหม่จากเซิร์ฟเวอร์
//         const data = await response.json(); // API ควรส่ง URL ใหม่กลับมา
//         const updatedImageUrl = data.travellerImage; // สมมติว่า API ส่ง URL รูปภาพกลับมา
...
//         // ✅ อัปเดต State เพื่อให้แสดงผลทันที
//         setTravellerImage(updatedImageUrl);
  
//         // ✅ ไปหน้า `mytravel` และให้ภาพที่อัปเดตแสดงผล
//         // navigate('/mytravel', { state: { updatedImageUrl } });
//         navigate('/mytravel', { state: { updatedImageUrl: updatedImageUrl } });
//       } else {
//         alert('ไม่สามารถบันทึกข้อมูลได้ กรุณาลองใหม่');
//       }
//     } catch (err) {
